...
class DuenosController {
  ...
  public async create({ request, response }: HttpContextContract) {
    try {
      ...
      // Crear un nuevo dueño en tu base de datos con el ID de usuario autogenerado
      const dueno = new Dueno();
      dueno.user_id = usuarioId; // Guarda el ID autogenerado en el modelo Dueno
      dueno.nombre = body.nombre;
      dueno.fecha_nacimiento = body.fecha_nacimiento;
      dueno.cedula = body.cedula;
      await dueno.save();
  
      // Responder con los datos del dueño creado
...
export default DuenosController;
